...
#
# Generated by export_simulation on Sat Jul 05 00:42:21 +0800 2025
#
################################################################################
...
'-reset_run' switch to the './imem_4.sh' script.
...
./imem_4.sh -noclean_files

For more information on the script, please type './imem_4.sh -help'.
