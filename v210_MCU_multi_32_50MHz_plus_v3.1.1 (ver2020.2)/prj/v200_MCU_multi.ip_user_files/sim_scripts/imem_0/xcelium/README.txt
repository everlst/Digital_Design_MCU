...
#
# Generated by export_simulation on Sat Jul 05 00:41:22 +0800 2025
#
################################################################################
...
'-reset_run' switch to the './imem_0.sh' script.
...
./imem_0.sh -noclean_files

For more information on the script, please type './imem_0.sh -help'.
