...
HD_PWD='Y:/Code/Digital_Design_MCU/Count_down/prj/Count_down/Count_down.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_countdown.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_countdown.tcl
