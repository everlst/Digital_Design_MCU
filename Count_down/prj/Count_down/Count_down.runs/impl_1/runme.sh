...
HD_PWD='Y:/Code/Digital_Design_MCU/Count_down/prj/Count_down/Count_down.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_countdown.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_countdown.tcl -notrace
