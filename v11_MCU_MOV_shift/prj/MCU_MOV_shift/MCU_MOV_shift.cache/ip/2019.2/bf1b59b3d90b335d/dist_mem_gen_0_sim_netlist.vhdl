...
\synth_options.dist_mem_inst\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_dist_mem_gen_v8_0_13_synth
     port map (
      ...
      spo(26) => \^spo\(29),
      spo(25) => \^spo\(30),
      spo(24 downto 8) => \^spo\(28 downto 12),
      spo(7 downto 0) => \^spo\(7 downto 0)
    );
end STRUCTURE;
library IEEE;
