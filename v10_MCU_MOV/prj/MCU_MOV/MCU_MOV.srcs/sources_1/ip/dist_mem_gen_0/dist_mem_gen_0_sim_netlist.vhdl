...
--               y:/Code/Digital_Design_MCU/MCU_MOV/prj/MCU_MOV/MCU_MOV.srcs/sources_1/ip/dist_mem_gen_0/dist_mem_gen_0_sim_netlist.vhdl
...
begin
  ...
  spo(26) <= \^spo\(6);
  spo(25 downto 12) <= \^spo\(25 downto 12);
  spo(11) <= \<const0>\;
  spo(10) <= \<const0>\;
  spo(9) <= \<const0>\;
  spo(8) <= \<const0>\;
...
\synth_options.dist_mem_inst\: entity work.dist_mem_gen_0_dist_mem_gen_v8_0_13_synth
     port map (
      ...
      spo(20) => \^spo\(6),
      spo(19 downto 6) => \^spo\(25 downto 12),
