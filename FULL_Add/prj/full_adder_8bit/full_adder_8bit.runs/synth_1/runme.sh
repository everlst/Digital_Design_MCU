...
HD_PWD='Y:/Code/FPGA-LIB/FULL_Add/prj/full_adder_8bit/full_adder_8bit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bit8_adder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bit8_adder.tcl
